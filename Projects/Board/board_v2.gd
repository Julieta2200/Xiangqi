...
func check_game_over() -> bool:
	...
	if generals.size() < 2:
		var winner_team = get_winner_team(generals)
		emit_signal("game_over", winner_team)
		return true
	return false

func get_winner_team(generals: Array) -> Teams:
	return generals[0].chess_component.team
