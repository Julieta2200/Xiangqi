...
func _ready() -> void:
	...
	var state: Array[State] = [
		...
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.SOLDIER, Vector2i(2,7)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.SOLDIER, Vector2i(5,6)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.SOLDIER, Vector2i(7,6)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.ELEPHANT, Vector2i(4,7)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.ELEPHANT, Vector2i(2,9)),
	]
