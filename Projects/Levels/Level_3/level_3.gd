...
func _ready() -> void:
	...
	var state: Array[State] = [
		...
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.CHARIOT, Vector2i(8,6)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.ELEPHANT, Vector2i(4,7)),
		State.new(BoardV2.Kingdoms.CLOUD, FigureComponent.Types.ELEPHANT, Vector2i(6,9)),
	]
