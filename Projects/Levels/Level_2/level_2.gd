...
func _ready() -> void:
	...
	DialogSystem.start_dialog([
		DialogSystem.DialogText.new("LEVEL_2_DIALOG_1", DialogSystem.CHARACTERS.Advisor),
		DialogSystem.DialogText.new("LEVEL_2_DIALOG_2", DialogSystem.CHARACTERS.Ashes),
		DialogSystem.DialogText.new("LEVEL_2_DIALOG_3", DialogSystem.CHARACTERS.Advisor),
		DialogSystem.DialogText.new("LEVEL_2_DIALOG_4", DialogSystem.CHARACTERS.Ashes),
	], true)
	_disable_play()
